...
const Sidebar = ({ isOpen, onClose, chatHistory }) => (
  <div 
    className={`fixed md:relative z-50 h-full bg-gradient-to-r from-gray-400 to-gray-300 border-r border-gray-200 transition-transform duration-300 flex flex-col
    ${isOpen ? 'translate-x-0' : '-translate-x-full'} 
    md:translate-x-0 md:w-80 w-[280px]`}
  >
